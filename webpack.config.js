...
module.exports = {
  mode: 'development',
  entry: { 
    script: ['./assets/js/script.js', './assets/js/header-controls-align.js', './assets/js/mobile-controls-cleanup.js', './assets/js/irish-language-option.js', './assets/css/header-controls.css', './assets/css/nav-tabs-polish.css', './assets/css/header-controls-balance.css', './assets/css/mobile-cta-row.css'],
