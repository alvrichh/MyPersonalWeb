...
const translations = {
  en: {
    ...
    contact: {
      eyebrow: 'Contact',
      title: "If your website needs to look sharper and communicate better, let's talk.",
      lead: 'This portfolio is now ready to present you better than a generic blog template. The next step is filling it with real projects, demos, or collaborations that speak directly about your work.',
      primaryAction: 'Open WhatsApp',
      secondaryAction: 'Visit LinkedIn',
      githubBody: 'Code, experiments, and the technical backbone.',
      linkedinBody: 'Professional profile and networking.',
      instagramBody: 'A more personal and visual presence.',
      whatsappBody: 'The fastest channel to move an idea forward.',
      footer: '2026 Alvaro Molina. Built on a clearer, more personal, and more flexible portfolio foundation.',
    },
  },
  es: {
    meta: {
    ...
    contact: {
      eyebrow: 'Contacto',
      title: 'Si tu web necesita verse mejor y comunicar mejor, hablemos.',
      lead: 'Este portfolio ya esta listo para presentarte mejor que una plantilla de blog generica. El siguiente paso es llenarlo con proyectos reales, demos o colaboraciones que hablen directamente de tu trabajo.',
      primaryAction: 'Abrir WhatsApp',
      secondaryAction: 'Ir a LinkedIn',
      githubBody: 'Codigo, experimentos y la base tecnica.',
      linkedinBody: 'Perfil profesional y networking.',
      instagramBody: 'Una presencia mas personal y visual.',
      whatsappBody: 'El canal mas rapido para mover una idea.',
      footer: '2026 Alvaro Molina. Construido sobre una base de portfolio mas clara, mas personal y mas flexible.',
    },
  },
  ru: {
    meta: {
    ...
    contact: {
      eyebrow: 'Контакт',
      title: 'Если вашему сайту нужно выглядеть лучше и говорить яснее, давайте поговорим.',
      lead: 'Это портфолио уже готово представлять вас лучше, чем обычный шаблон блога. Следующий шаг — наполнить его реальными проектами, демо или сотрудничествами, которые прямо расскажут о вашей работе.',
      primaryAction: 'Открыть WhatsApp',
      secondaryAction: 'Перейти в LinkedIn',
      githubBody: 'Код, эксперименты и техническая основа.',
      linkedinBody: 'Профессиональный профиль и нетворкинг.',
      instagramBody: 'Более личное и визуальное присутствие.',
      whatsappBody: 'Самый быстрый канал, чтобы продвинуть идею.',
      footer: '2026 Alvaro Molina. Создано на основе более ясной, личной и гибкой базы портфолио.',
    },
  },
  zh: {
    meta: {
    ...
    contact: {
      eyebrow: '联系',
      title: '如果你的网站需要更好看、表达也更清楚，我们聊聊。',
      lead: '这个作品集现在已经比普通博客模板更能代表你。下一步，就是用真实项目、演示或合作内容把它填满，让它真正讲出你的工作。',
      primaryAction: '打开 WhatsApp',
      secondaryAction: '前往 LinkedIn',
      githubBody: '代码、实验，以及技术底座。',
      linkedinBody: '职业档案与人脉连接。',
      instagramBody: '更个人化、更视觉化的一面。',
      whatsappBody: '推进想法最快的渠道。',
      footer: '2026 Alvaro Molina。建立在一个更清晰、更个人化、也更灵活的作品集基础之上。',
    },
  },
  pl: {
    meta: {
    ...
    contact: {
      eyebrow: 'Kontakt',
      title: 'Jesli twoja strona ma wygladac lepiej i komunikowac wyrazniej, porozmawiajmy.',
      lead: 'To portfolio jest juz gotowe, by prezentowac cie lepiej niz generyczny szablon bloga. Kolejny krok to wypelnienie go prawdziwymi projektami, demo lub wspolpracami, ktore wprost opowiadaja o twojej pracy.',
      primaryAction: 'Otworz WhatsApp',
      secondaryAction: 'Przejdz do LinkedIn',
      githubBody: 'Kod, eksperymenty i techniczny fundament.',
      linkedinBody: 'Profil zawodowy i networking.',
      instagramBody: 'Bardziej osobista i wizualna obecnosc.',
      whatsappBody: 'Najszybszy kanal, by ruszyc pomysl do przodu.',
      footer: '2026 Alvaro Molina. Zbudowane na bardziej klarownej, bardziej osobistej i bardziej elastycznej bazie portfolio.',
    },
  },
  de: {
    meta: {
    ...
    contact: {
      eyebrow: 'Kontakt',
      title: 'Wenn deine Website besser aussehen und klarer kommunizieren soll, lass uns sprechen.',
      lead: 'Dieses Portfolio ist jetzt bereit, dich besser zu praesentieren als ein generisches Blog-Template. Der naechste Schritt ist, es mit echten Projekten, Demos oder Kooperationen zu fuellen, die deine Arbeit direkt zeigen.',
      primaryAction: 'WhatsApp oeffnen',
      secondaryAction: 'Zu LinkedIn',
      githubBody: 'Code, Experimente und das technische Rueckgrat.',
      linkedinBody: 'Berufliches Profil und Networking.',
      instagramBody: 'Eine persoenlichere und visuellere Praesenz.',
      whatsappBody: 'Der schnellste Kanal, um eine Idee voranzubringen.',
      footer: '2026 Alvaro Molina. Gebaut auf einer klareren, persoenlicheren und flexibleren Portfolio-Basis.',
    },
  },
  ar: {
    meta: {
    ...
    contact: {
      eyebrow: 'التواصل',
      title: 'إذا كان موقعك يحتاج أن يبدو أفضل ويتواصل بشكل أوضح، فلنتحدث.',
      lead: 'هذا الملف أصبح جاهزا ليقدمك بشكل أفضل من قالب مدونة عام. والخطوة التالية هي ملؤه بمشاريع حقيقية أو عروض أو تعاونات تتحدث مباشرة عن عملك.',
      primaryAction: 'فتح WhatsApp',
      secondaryAction: 'زيارة LinkedIn',
      githubBody: 'الكود، والتجارب، والأساس التقني.',
      linkedinBody: 'الملف المهني وبناء العلاقات.',
      instagramBody: 'حضور أكثر شخصية وبصرية.',
      whatsappBody: 'أسرع قناة لدفع الفكرة إلى الأمام.',
      footer: '2026 Alvaro Molina. مبني على قاعدة ملف شخصي أوضح وأكثر شخصية وأكثر مرونة.',
    },
  },
  and: {
    meta: {
    ...
    contact: {
      eyebrow: 'Contacto',
      title: 'Si tu web necesita verse mejor y contá las cosas más claritas, hablemo.',
      lead: 'Este portfolio ya está listo pa presentarte mejor que una plantilla genérica de blog. Er siguiente paso es llenarlo con proyectos reales, demos o colaboraciones que hablen clarito de tu curro.',
      primaryAction: 'Abrí WhatsApp',
      secondaryAction: 'Ir a LinkedIn',
      githubBody: 'Código, experimentos y la base técnica.',
      linkedinBody: 'Perfil profesional y networking.',
      instagramBody: 'Una presencia más personal y más visual.',
      whatsappBody: 'Er canal más rápido pa mover una idea.',
      footer: '2026 Alvaro Molina. Montao sobre una base de portfolio más clara, más personal y con más sentío.',
    },
  },
};
